                                ...
                                <tr>
                                    ...
                                    <td>
                                        <button class="btn btn-sm btn-info btn-round  dropdown-toggle" type="button"
                                            id="dropPaid{{$order->order->id}}" data-toggle="dropdown"
                                            aria-expanded="false">
                                            @php
                                        ...
                                        <div class="dropdown-menu" aria-labelledby="dropPaid{{$order->order->id}}">
                                            ...
                                            <a class="dropdown-item"
                                                href="/seller/mark_as_unpaid/{{$order->order_id}}">Not
                                                Paid</a>
                                        </div>
                                        <br>
                                    ...
                                    <td>
                                        ...
                                        <div class="dropdown-menu" aria-labelledby="dropStatus{{$order->order->id}}">
                                            ...
                                            <a class="dropdown-item"
                                                href="/edit_pickup_status/{{$option->id}}/{{$order->order_id}}">{{$option->display_name}}</a>
                                            @endif
                                            @endforeach
                                        </div>
                                        @endif
