                        ...
                        <div class="table-responsive">
                            ...
                            <table id="datatable" class="table " cellspacing="0" width="100%">
                                ...
                                @if (isset($pre_order->product->shop->id))                    
                                        ...
                                        <td>
                                            <form id="{{$pre_order->pre_order_id}}" method="POST" action="{{ route('confirmOrderfrmPreOrderAdmin') }}">
                                                @csrf
                                            ...
                                            <a href="/admin/delete_pre_order/{{$pre_order->id}}" class="btn btn-sm btn-danger btn-round text-white m-1">Delete</a>
                                        </td>
                                    </tr>
                                    @endif
                                @endforeach
