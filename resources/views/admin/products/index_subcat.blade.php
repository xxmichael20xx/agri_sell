                ...
                @endif</td>
                        ...
                        <td>
                            <a class="btn btn-sm btn-primary btn-round text-white m-1"
                                href="/admin_seller/product_info/{{$product->id}}">More info</a>
                            <a hidden class="btn btn-sm btn-warning btn-round text-white m-1"
                                href="/admin_seller/product_edit/{{$product->id}}">Edit</a>
                            <a class="btn btn-sm btn-danger btn-round text-white m-1"
                                href="/admin_seller/delete_product/{{$product->id}}">Delete</a>
                        </td>
                    </tr>
                    @endif
                    @endif
