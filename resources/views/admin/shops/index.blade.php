                    ...
                    <div class="card-header d-flex justify-content-between">
                        ...
                        <div class="dropdown">
                            ...
                            <div class="dropdown-menu">
                                ...
                                <a class="dropdown-item clickable" data-href="/export/csv/shops/current/default" data-toggle="modal" data-target="#csvMonths">CSV/PDF - Current Month</a>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title">CSV - Months Report</h5>
                </div>
