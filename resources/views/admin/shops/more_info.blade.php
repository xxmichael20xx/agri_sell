                    ...
                    <div class="button-container">
                        <div class="row">
                            <div class="col-lg-3 col-md-6 col-6 ml-center">
                                <h5 class="text-center">{{ $order_count }}<br><small>Total orders</small></h5>
                            </div>
                            <div hidden class="col-lg-4 col-md-6 col-6 ml-auto mr-auto">
                                <h5 class="text-center">{{ $shopAveRating }}<br><small>Average rating</small></h5>
                            </div>
                            <div hidden class="col-lg-3 mr-auto">
                                <h5 class="text-center">&#8369;{{ $total_sales }}<br><small>Total sales</small></h5>
                            </div>
                        </div>
                    </div>
                </div>
