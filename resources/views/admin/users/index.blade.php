            ...
            <div class="nav-tabs-navigation">
                <div class="nav-tabs-wrapper">
                    <ul id="tabs" class="nav nav-tabs" role="tablist">
                        <li class="nav-item">
                            <a class="nav-link active" data-toggle="tab" href="#reg_user" role="tab"
                                aria-expanded="true">Regular user</a>
                        </li>
                        <li class="nav-item">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" data-toggle="tab" href="#seller" role="tab"
                                aria-expanded="false">Seller</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" data-toggle="tab" href="#rider" role="tab"
                                aria-expanded="false">Rider</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" data-toggle="tab" href="#employee" role="tab"
                                aria-expanded="false">Coins top up employee</a>
                        </li>
                    </ul>
                </div>
            </div>
