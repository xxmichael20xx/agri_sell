                ...
                <script>
                    $('[data-countdown]').each(function () {
                        ...
                        <div class="details-price">
                            ...
                            // changelog mar 17 2022
                            $product_wholesale_min_qty_initial = DB::table('product_variations')->where('product_id', $product->id)->pluck('variation_min_qty_wholesale')->first();
                            $product_wholesale_price_per_initial = DB::table('product_variations')->where('product_id', $product->id)->pluck('variation_wholesale_price_per')->first();
                        ...
                        <!-- changelog change GET to POST addWquantityVariation -->
                        ...
                        <div class="quick-view-select">
                                <div class="select-option-part" {{$hidden_product}}>
                                    ...
                                    <select class="select" id="product_variation_value_selector" onchange="prodSetter()">  
                                       ...
                                       <!-- javascript array variables from php -->
                                        @php
                                            ...
                                            // changelog mar 17 2022
                                            $product_variation_wholesale_min_qtys = "[";
                                            $product_variation_wholesale_price_pers = "[";
                                        ...
                                        @php
                                            ...
                                            // changelog mar 17 2022
                                            $product_variation_wholesale_min_qtys .= "\"" .$product_variation->variation_min_qty_wholesale . "\",";
                                            $product_variation_wholesale_price_pers .= "\"" .$product_variation->variation_wholesale_price_per . "\",";
                                       ...
                                       <!-- rtrim function for checking the excess comma in the temp var array for javascript -->
                                        ...
                                        // changelog mar 17 2022
                                        $product_variation_wholesale_min_qtys = rtrim($product_variation_wholesale_min_qtys, ',');
                                        $product_variation_wholesale_min_qtys  .= "]";

                                        $product_variation_wholesale_price_pers = rtrim($product_variation_wholesale_price_pers, ',');
                                        $product_variation_wholesale_price_pers  .= "]";

                                        @endphp
                                    </select>
                                    
                                    <input type="hidden" required id="variation_id_setter" name="variation_id" value="{{$product_variation_id_first}}">                                    
                                    <!-- {{ $product_variation_prices }} -->
                                </div>
                                ...
                                <script>
                                    ...
                                    // changelog mar 17 2022
                                    var product_variation_wholesale_min_list = {!! $product_variation_wholesale_min_qtys !!};
                                    var product_variation_wholesale_price_pers_list = {!! $product_variation_wholesale_price_pers !!};
                                    ...
                                    function prodSetter() {
                                        ...
                                        if(product_variation_selector_value == 'undefined'){
                                            ...
                                            // changelog mar 17 2022 
                                            var min_qty_Wholesale = {{$product_wholesale_min_qty_initial}};
                                            var price_wholesale = {{$product_wholesale_price_per_initial}};
