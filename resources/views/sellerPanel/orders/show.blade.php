                        ...
                        <tbody>
                            ...
                            @foreach($items as $item)
                                ...
                                @php
                                    ...
                                    $item_product_price_proc = $product_variety_ent->variation_price_per ?? '0' - (($item_product_pivot->sale_pct_deduction
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a class="btn btn-primary" href="/seller_product_monitor/{{$item->id}}">Product monitoring</a>
                                    </td>
                                </tr>
                            @endforeach
