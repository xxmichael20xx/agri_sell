    ...
    <div class="card-body">
        ...
        <div class="form-group row">
            ...
            <div class="col-md-9">
                ...
                @endphp
                <select class="selectpicker w-100" data-style="btn btn-primary btn-round" title="Select product category" name="category_id" required>
        ...
        <div class="form-group row">
            ...
            <div class="col-md-9">
                <div class="form-group">
                    <input type="number" class="form-control" name="sale_pct_deduction" value="">
                </div>
            </div>
        </div>
