<div class="card-body">
                        ...
                        <div class=""></div>
                            ...
                            <div class="row">
                                <label class="col-md-3 col-form-label">Regular retail product weight</label>
                                <div class="col-md-5">
                                    <div class="form-group">
                            ...
                            <div class="row">
                                <label class="col-md-3 col-form-label">Regular retail stocks</label>
                                <div class="col-md-9">
                                    <div class="form-group">
                            ...
                            <div class="row">
                                <label class="col-md-3 col-form-label">Regular Wholesale Stocks</label>
                                <div class="col-md-9">
                                    <div class="form-group">
                                        <input type="number" class="form-control" form="addProduct" value="" name="stocks">
                                    </div>
