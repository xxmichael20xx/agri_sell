...
@section('content')
    ...
    <div class="content" >
        <a href="/sellerpanel/products" onload="presetter()" class="btn btn-outline-dark btn-round m-1 mb-2">Go back</a>
        <div class="row">
            <div class="col col-12 col-lg-9">
                <div class="card">
                    <form method="POST" id="editProduct" enctype="multipart/form-data" action="{{ route('edit_product_sell')}}">
                        @csrf
                        @method('POST')
                    </form>
                    ...
                    <div class="row">
                        ...
                        <div class="row">
                            <input type="hidden" name="shop_id"  form="editProduct" value="{{Auth::user()->shop->id}}" >     
                        </div>
