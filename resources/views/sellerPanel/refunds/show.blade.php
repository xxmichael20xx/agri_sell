...
<div class="content">
    <a href="/sellerpanel/refunds/" class="btn btn-outline-dark btn-round mb-4">Go back</a>
                ...
                <div class="card-body">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-12 my-3">
                            <span class="text-muted dark-highlight">Refund details:</b> ID {{ $refund->refund_ref_id }}</span>
                        </div>
                        <div class="col-12 mb-3">
                            <span class="text-dark">
                        ...
                        <div class="col-12 mb-3">
                            <span class="text-muted"><b>Amount:</b> ₱ {{ AppHelpers::numeric( $amount ) }}</span>
                        </div>
                        @if ( $refund->status == '2' )
                            <div class="col-12 mb-3">
                        ...
                        @elseif ( $refund->status == '3' )
                            <div class="col-12 mb-3">
                                <span class="text-muted"><b>Refund confirmed:</b> (amount) ₱ {{ AppHelpers::numeric( $amount / 2 ) }}</span>
                            </div>
                            <div class="col-12 mb-3">
                        ...
                        Swal.fire({
                            ...
                            preConfirm: () => {
                                ...
                                return fetch( href, {
                                    ...
                                    body: JSON.stringify({ reason: reason, user_id: user_id, status: 4 }) 
                                }).then( response => {
                                    if ( ! response.ok ) {
