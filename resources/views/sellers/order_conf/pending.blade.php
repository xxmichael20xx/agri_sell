    ...
    <div class="row align-items-center h-100">
        <div class="col-9 mx-auto">
            <div class="jumbotron bg-white text-center">
                ...
                @if ( $seller_reg_fee_obj->info )
                    @if ( $seller_reg_fee_obj->info->remarks == 'invalid' )
                        <h1 class="display-6">Please pay your seller registration fee</h1>
                        <p class="text-secondary">If you believe that this is wrong send an email to {{ env('MAIL_USERNAME') }}</p>
                    ...
                    <h3 class=" lead">Invalid payment proof</h3>
                        ...
                        <br>
                        <a href="registration_fee_instructions" class="btn btn-success text-white">Re submit payment proof</a>
                    @endif
